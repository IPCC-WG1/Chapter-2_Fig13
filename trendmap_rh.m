...
amiss = -999.9;
fname='../data/HadISDH.blendRH.1.0.0.2019f.nc';
rh=ncread('HadISDH.blendRH.1.0.0.2019f.nc', 'rh_abs');
rh=permute(rh,[3,1,2]);
...
print(['MLOST_tr_RH' sper '.eps'], '-depsc')
...
fclose(fido)
	...
	figure(ip+1)
clf
xlabelstr='Trend (%RH per decade)';
fontsizenum=24;
printformstr='-depsc';
foutstr='cbhor_SurfRH_Trend';
colormap(flip(C))
